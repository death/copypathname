========================================================================
    ACTIVE TEMPLATE LIBRARY : CopyPathname Project Overview
========================================================================

AppWizard has created this CopyPathname project for you to use as the starting point for
...
_CopyPathname.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_CopyPathname.h)
        GUID definitions                                (_CopyPathname_i.c)
        A type library                                  (_CopyPathname.tlb)
        Marshaling code                                 (_CopyPathname_p.c and dlldata.c)
CopyPathname.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named CopyPathname.pch and a precompiled types file named StdAfx.obj.
...
CopyPathnameps.vcproj
	...
	dlldata.c, CopyPathname_i.c and CopyPathname_p.c which are required
